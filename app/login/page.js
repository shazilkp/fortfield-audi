...
export default function LoginForm() {
  ...
  <div className="relative min-h-screen bg-cover bg-center bg-no-repeat bg-gradient-to-b from-pink-300 via-purple-300 to-blue-300 px-2 text-white"
  ...
  <form
    className="backdrop-blur-sm mt-28 bg-white/10 p-8 rounded-2xl shadow-xl border border-white/30 w-full max-w-sm text-white"
